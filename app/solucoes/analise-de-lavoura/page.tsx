...
import { ArrowLeft, ChevronRight, Cpu, LineChart, Menu, TreesIcon as Plant, ScanLine } from "lucide-react"

export default function AnaliseDeLavoura() {
  return (
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-6">
                <div className="inline-flex items-center rounded-full border border-green-500/30 bg-green-500/10 px-3 py-1 text-sm text-green-400 dark:border-green-500/30 dark:bg-green-500/10 dark:text-green-400 light:border-green-600/30 light:bg-green-500/10 light:text-green-600">
                  <Plant className="mr-1 h-3 w-3" /> Monitoramento avançado
                </div>
                ...
                <p className="max-w-[600px] text-gray-400 md:text-xl dark:text-gray-400 light:text-gray-600">
                  Monitoramento em tempo real da saúde das plantas, com alertas e recomendações personalizadas para
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl border border-green-500/30 bg-black/40 backdrop-blur-sm p-1 overflow-hidden dark:border-green-500/30 dark:bg-black/40 light:border-green-600/30 light:bg-white/40">
                  ...
                  <div className="absolute top-4 right-4 rounded-lg border border-green-500/30 bg-black/60 backdrop-blur-sm p-2 text-xs text-green-400 flex items-center dark:border-green-500/30 dark:bg-black/60 dark:text-green-400 light:border-green-600/30 light:bg-white/60 light:text-green-600">
                    <LineChart className="mr-1 h-3 w-3" /> Análise em tempo real
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[700px] text-gray-400 md:text-xl/relaxed dark:text-gray-400 light:text-gray-600">
                Conheça os recursos que tornam nossa solução de análise de lavoura única
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Imagens de alta resolução para monitoramento completo da sua lavoura, com atualização constante.",
                  icon: ScanLine,
                },
                {
                  title: "Análise de Crescimento",
                  desc: "Acompanhamento do desenvolvimento das plantas com métricas precisas e comparativos históricos.",
                  icon: LineChart,
                },
                {
                  title: "Previsão de Colheita",
                  desc: "Estimativas de produtividade baseadas em dados históricos e condições atuais da lavoura.",
                  icon: Plant,
                },
                {
                  title: "Detecção de Anomalias",
                  desc: "Identificação precoce de áreas com problemas potenciais para intervenção rápida.",
                  icon: Cpu,
                },
                {
                  title: "Recomendações Personalizadas",
                  desc: "Sugestões de manejo específicas para cada área da lavoura, baseadas em dados reais.",
                  icon: LineChart,
                },
                {
                  title: "Relatórios Detalhados",
                  desc: "Documentação completa do histórico da lavoura para análises e planejamento futuro.",
                  icon: ScanLine,
                },
              ].map((feature, i) => (
                <div
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="mx-auto max-w-3xl rounded-2xl border border-green-500/30 bg-black/40 backdrop-blur-sm p-8 md:p-12 dark:border-green-500/30 dark:bg-black/40 light:border-green-600/30 light:bg-white/40">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="inline-flex items-center rounded-full border border-green-500/30 bg-green-500/10 px-3 py-1 text-sm text-green-400 dark:border-green-500/30 dark:bg-green-500/10 dark:text-green-400 light:border-green-600/30 light:bg-green-500/10 light:text-green-600">
                  <LineChart className="mr-1 h-3 w-3" /> Caso de sucesso
                </div>
                ...
                <p className="max-w-[600px] text-gray-300 md:text-xl/relaxed dark:text-gray-300 light:text-gray-700">
                  "Com o AgroSinapse, aumentamos a produtividade da nossa lavoura de soja em 23% em apenas uma safra. A
                  análise de lavoura nos permitiu identificar áreas com problemas antes que afetassem toda a plantação."
                </p>
                <div className="mt-4 flex items-center justify-center">
                  <div className="h-12 w-12 rounded-full bg-zinc-800 dark:bg-zinc-800 light:bg-gray-200"></div>
                  <div className="ml-4 text-left">
                    <p className="font-medium text-white dark:text-white light:text-green-800">João Silva</p>
                    <p className="text-xs text-gray-400 dark:text-gray-400 light:text-gray-600">Produtor Rural - MT</p>
                  </div>
                </div>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 pt-4 border-t border-green-500/20 dark:border-green-500/20 light:border-green-600/20">
                  {[
                    { value: "23%", label: "Aumento de produtividade" },
                    { value: "15%", label: "Redução de custos" },
                    { value: "2.500", label: "Hectares monitorados" },
                  ].map((stat, i) => (
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[600px] text-gray-300 md:text-xl/relaxed dark:text-gray-300 light:text-gray-700">
                Entre em contato e descubra como nossa solução de análise de lavoura pode ajudar a aumentar sua
                produtividade.
              </p>
