...
import { ArrowLeft, ChevronRight, CloudRain, Cpu, Menu, TreesIcon as Plant, ScanLine, BarChart3 } from "lucide-react"

export default function GestaoDeIrrigacao() {
  return (
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-6">
                <div className="inline-flex items-center rounded-full border border-green-500/30 bg-green-500/10 px-3 py-1 text-sm text-green-400 dark:border-green-500/30 dark:bg-green-500/10 dark:text-green-400 light:border-green-600/30 light:bg-green-500/10 light:text-green-600">
                  <CloudRain className="mr-1 h-3 w-3" /> Gestão inteligente
                </div>
                ...
                <p className="max-w-[600px] text-gray-400 md:text-xl dark:text-gray-400 light:text-gray-600">
                  Controle inteligente da irrigação baseado em dados climáticos e necessidades da cultura, otimizando o
                  uso da água e aumentando a produtividade.
                </p>
              ...
              <div className="relative">
                ...
                <div className="relative rounded-2xl border border-green-500/30 bg-black/40 backdrop-blur-sm p-1 overflow-hidden dark:border-green-500/30 dark:bg-black/40 light:border-green-600/30 light:bg-white/40">
                  <Image
                    src="https://images.unsplash.com/photo-1622383563227-04401ab4e5ea?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    width={600}
                    height={400}
                    alt="Gestão de Irrigação"
                  ...
                  <div className="absolute top-4 right-4 rounded-lg border border-green-500/30 bg-black/60 backdrop-blur-sm p-2 text-xs text-green-400 flex items-center dark:border-green-500/30 dark:bg-black/60 dark:text-green-400 light:border-green-600/30 light:bg-white/60 light:text-green-600">
                    <CloudRain className="mr-1 h-3 w-3" /> Irrigação inteligente
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[700px] text-gray-400 md:text-xl/relaxed dark:text-gray-400 light:text-gray-600">
                Conheça os recursos que tornam nossa solução de gestão de irrigação única
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Otimização do uso da água com base nas necessidades reais da cultura, evitando desperdícios e reduzindo custos.",
                  icon: CloudRain,
                },
                {
                  title: "Programação Automática",
                  desc: "Definição inteligente de cronogramas de irrigação baseados em dados climáticos e estágio de desenvolvimento das plantas.",
                  icon: Cpu,
                },
                {
                  title: "Alertas de Déficit Hídrico",
                  desc: "Notificações em tempo real sobre condições de estresse hídrico, permitindo intervenções rápidas.",
                  icon: ScanLine,
                },
                {
                  title: "Monitoramento Climático",
                  desc: "Acompanhamento de condições meteorológicas e previsões para ajuste automático da irrigação.",
                  icon: CloudRain,
                },
                {
                  title: "Análise de Eficiência",
                  desc: "Relatórios detalhados sobre o uso da água e eficiência do sistema de irrigação.",
                  icon: BarChart3,
                },
                {
                  title: "Controle Remoto",
                  desc: "Gerenciamento do sistema de irrigação à distância, através de aplicativo móvel ou plataforma web.",
                  icon: Cpu,
                },
              ].map((feature, i) => (
                <div
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="mx-auto max-w-3xl rounded-2xl border border-green-500/30 bg-black/40 backdrop-blur-sm p-8 md:p-12 dark:border-green-500/30 dark:bg-black/40 light:border-green-600/30 light:bg-white/40">
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="inline-flex items-center rounded-full border border-green-500/30 bg-green-500/10 px-3 py-1 text-sm text-green-400 dark:border-green-500/30 dark:bg-green-500/10 dark:text-green-400 light:border-green-600/30 light:bg-green-500/10 light:text-green-600">
                  <CloudRain className="mr-1 h-3 w-3" /> Caso de sucesso
                </div>
                ...
                <p className="max-w-[600px] text-gray-300 md:text-xl/relaxed dark:text-gray-300 light:text-gray-700">
                  "Implementamos o sistema de gestão de irrigação da AgroSinapse e conseguimos reduzir o consumo de água
                  em 30% enquanto aumentamos a produtividade em 15%. O sistema nos ajuda a irrigar no momento certo e na
                  quantidade ideal."
                </p>
                <div className="mt-4 flex items-center justify-center">
                  <div className="h-12 w-12 rounded-full bg-zinc-800 dark:bg-zinc-800 light:bg-gray-200"></div>
                  <div className="ml-4 text-left">
                    <p className="font-medium text-white dark:text-white light:text-green-800">Mariana Santos</p>
                    <p className="text-xs text-gray-400 dark:text-gray-400 light:text-gray-600">Produtora Rural - MG</p>
                  </div>
                </div>
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 pt-4 border-t border-green-500/20 dark:border-green-500/20 light:border-green-600/20">
                  {[
                    { value: "30%", label: "Economia de água" },
                    { value: "15%", label: "Aumento de produtividade" },
                    { value: "1.800", label: "Hectares irrigados" },
                  ].map((stat, i) => (
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative z-10">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl bg-clip-text text-transparent bg-gradient-to-r from-white via-green-200 to-green-400 dark:from-white dark:via-green-200 dark:to-green-400 light:from-green-800 light:via-green-600 light:to-green-700">
                Otimize sua irrigação hoje mesmo
              </h2>
              <p className="max-w-[600px] text-gray-300 md:text-xl/relaxed dark:text-gray-300 light:text-gray-700">
                Entre em contato e descubra como nossa solução de gestão de irrigação pode ajudar a economizar água e
